...
import Contracts.CrowdFundContract qualified as CrowdFundContract
import Contracts.CrowdFundContract2 qualified as CrowdFundContract2
...
contracts =
  [ CrowdFundContract.exports,
    CrowdFundContract2.exports
  ]
